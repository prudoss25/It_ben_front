...
class GaleriePhoto extends Component{
     ...
     Data_Photo=[
        ...
        p=0;
        afficher_masquer =() =>{
            (this.p === -this.n+1) ? this.setState({masquerGauche:{visibility:'hidden'}}) : this.setState({masquerGauche:{visibility:'visible'}});
    ...
    render(){
        ...
        return(
            <Aux>
                <p className={classes.titre_Galerie}>
                    <h1>Galerie Photo</h1>
                </p>
                <div id= {classes.carousel}>
                    <div style={this.state.style} >
                        {this.Data_Photo.map((photo,index) => (
                                <div className={classes.image} key={index}><img src={photo.image} alt="photo_carousel"  /></div>
                            
                            ))}
                            
                    </div>
                    <img src={chevronGauche} alt="chevronGauche" style={this.state.masquerGauche} className={classes.chevron} id={classes.gauche} onClick={this.boutonGaucheHandler}/>
                    <img src={chevronDroit} alt="chevronDroit" style={this.state.masquerDroit} className={classes.chevron} id={classes.droit} onClick={this.boutonDroitHandler}/>
                </div>
            </Aux>
        )
    }
